...
public class UpdateOrderStatusCommandValidator implements CommandValidator {
    ...
    public boolean validate(HttpServletRequest request, HttpServletResponse response) {
        ...
        return (CommandValidatorHelper.getInstance().isNullValidate(new String[]{ORDER_STATUS_ATTRIBUTE}, RESULT_ATTRIBUTE,
                CommandHelper.getInstance().roleCheckerSetAttributes(ORDER_JSP, request), message, request, response))
                &&
                CommandValidatorHelper.getInstance().isEmptyValidate(new String[]{ORDER_STATUS_ATTRIBUTE}, RESULT_ATTRIBUTE,
                CommandHelper.getInstance().roleCheckerSetAttributes(ORDER_JSP, request), message, request, response);
    }
}
